...
<script type="text/javascript" src="js/checkPenJingManage.js"></script>
<style type="text/css">
...
<table id="dg" title="盆景管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
	url="penjings/getCheckPenjing" toolbar="#tools" fit="true" pageSize="10" singleSelect="true">
	<thead>
		<tr>
	...
	<div id="tools">
		<div>
			<a class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="openeditdialog()">审批</a>
		</div>
	</div>
